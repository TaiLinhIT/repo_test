...
<body class="bg-[#FFFFFF]">
        ...
        <div class="col-start-2 col-end-4 absolute flex  left-1/2 transform -translate-x-1/2 items-end w-2/3 mx-8">
            ...
            <div class="font-custom flex flex-col justify-start items-center ml-8">
              ...
              <nav class="font-bold text-xl text-black leading-5">
                <a class="py-4 px-1 inline-flex items-center gap-2 border-b-4 border-transparent whitespace-nowrap hover: focus:outline-none focus:text-red-600 dark:text-neutral-500 dark:hover:text-red-500 dark:focus:text-red-500" href="">
                  Trang chủ
                </a>
                <a class="py-4 px-1 inline-flex items-center gap-2 border-b-4 border-red-700 font-medium whitespace-nowrap focus:outline-none focus:  dark:text-red-500" href="#" aria-current="page">
                  Truyện
                </a>
                <a class="py-4 px-1 inline-flex items-center gap-2 border-b-4 border-transparent whitespace-nowrap hover:  focus:outline-none focus:text-blue-600 dark:text-neutral-500 dark:hover:text-blue-500 dark:focus:text-blue-500" href="#">
                  Giải trí
                </a>
              </nav>
            </div>
    ...
    <div class="relative">
        <section class="absolute grid grid-cols-4 top-full left-1/2 transform -translate-x-1/2 mt-[-2rem] bg-white p-4 shadow-lg rounded w-2/3 text-[#1f2937]">
            <article class="mx-5 col-span-3">
                <p class="mb-10 text-xl leading-8">Website nghe truyện Danda, được xây dựng bởi <a href="#" class="underline font-extrabold">Harry</a> bao gồm tất cả bộ truyện được dịch từ <a href="#" class="underline font-semibold">website đọc truyện chính thức</a> của chúng tôi và chuyển thành audio.</p>
                ...
                <div class="leading-6">
                    ...
                    <div class="flex w-70">
                        ...
                        <h2 class="text-lg font-bold text-[#4b5563]">[Chương 70] - Sinh cục cưng cho bạo quân phản diện rồi phải làm sao đây?</h2>
