<div class="rounded border font-custom">
    <div class="flex">
        <button class="mr-5">
        ...
        <p class="text-sm leading-3 font-medium text-[#6b7280]">[Chương 70] - Sinh cục cưng cho bạo quân phản diện rồi phải làm sao đây?</p>
        <input type="range"/>
